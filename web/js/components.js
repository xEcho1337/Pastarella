(function () {
    ...
    var NAV = [
        ...
        },
        {
            ...
            file: "network.html",
            title: "Network",
            sub: "Open ports and hosts",
        },
        {
            id: "system",
            file: "system.html",
            title: "System",
            sub: "Processes, users, storage",
        },
        {
            id: "persistence",
            file: "persistence.html",
            title: "Persistence",
            sub: "Persistence points",
        },
        {
            id: "environment",
            file: "environment.html",
            title: "Environment",
            sub: "Env vars and history",
        },
        {
            id: "containers",
        ...
        },
        {
            ...
            file: "drivers.html",
            title: "Drivers",
            sub: "Drivers and kernel modules",
        },
        {
            id: "recent-files",
            file: "recent-files.html",
            title: "Recent Files",
            sub: "Recently accessed files",
        },
    ];
    ...
    function emptyStateFrag(item) {
        ...
        frag.querySelector(".empty-report-text").textContent =
            "Load an AnalysisReport JSON to inspect " +
